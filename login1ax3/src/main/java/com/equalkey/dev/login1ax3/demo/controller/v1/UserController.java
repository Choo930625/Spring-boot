package com.equalkey.dev.login1ax3.demo.controller.v1;

import com.equalkey.dev.login1ax3.demo.config.security.JwtTokenProvider;
...
public class UserController {
    ...
    public ListResult<User> findAllUser() {
        ...
        return responseService.getSuccessListResult(userJpaRepo.findAll());
    }
    ...
    public SingleResult<User> findUserById(@ApiParam(value = "언어", defaultValue = "ko") @RequestParam String lang) {
        ...
        return responseService.getSuccessSingleResult(userJpaRepo.findByUid(id).orElseThrow(UserNotFoundException::new));
    }
    ...
    public SingleResult<User> modify(
        ...
        User user = User.builder()
                ...
                .name(name)
                .build();
        return responseService.getSuccessSingleResult(userJpaRepo.save(user));
    }
